...
impl PartiesV1PartiesPartyIdGet200Response {
    pub fn new(id: String, muc_name: String, voice_room_id: String, version: f64, client_version: String, members: Vec<models::PartiesV1PartiesPartyIdGet200ResponseMembersInner>, state: String, previous_state: String, state_transition_reason: String, accessibility: models::PartiesV1PartiesPartyIdGet200ResponseAccessibility, custom_game_data: models::PartiesV1PartiesPartyIdGet200ResponseCustomGameData, matchmaking_data: models::PartiesV1PartiesPartyIdGet200ResponseMatchmakingData, invites: Option<serde_json::Value>, requests: Vec<serde_json::Value>, queue_entry_time: String, error_notification: models::PartiesV1PartiesPartyIdGet200ResponseErrorNotification, restricted_seconds: f64, eligible_queues: Vec<String>, queue_ineligibilities: Vec<String>, cheat_data: models::PartiesV1PartiesPartyIdGet200ResponseCheatData, xp_bonuses: Vec<serde_json::Value>, invite_code: String) -> PartiesV1PartiesPartyIdGet200Response {
