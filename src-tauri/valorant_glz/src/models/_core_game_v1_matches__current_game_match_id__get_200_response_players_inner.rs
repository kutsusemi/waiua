...
impl CoreGameV1MatchesCurrentGameMatchIdGet200ResponsePlayersInner {
    pub fn new(subject: String, team_id: models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerTeamId, character_id: String, player_identity: models::PartiesV1PartiesPartyIdGet200ResponseMembersInnerPlayerIdentity, seasonal_badge_info: models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInnerSeasonalBadgeInfo, is_coach: bool, is_associated: bool) -> CoreGameV1MatchesCurrentGameMatchIdGet200ResponsePlayersInner {
