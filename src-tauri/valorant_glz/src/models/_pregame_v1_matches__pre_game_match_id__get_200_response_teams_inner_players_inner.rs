...
pub struct PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInner {
    ...
    pub seasonal_badge_info: Box<models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInnerSeasonalBadgeInfo>,
    #[serde(rename = "IsCaptain")]
    pub is_captain: bool,
}

impl PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInner {
    pub fn new(subject: String, character_id: String, character_selection_state: CharacterSelectionState, pregame_player_state: PregamePlayerState, competitive_tier: f64, player_identity: models::PartiesV1PartiesPartyIdGet200ResponseMembersInnerPlayerIdentity, seasonal_badge_info: models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInnerSeasonalBadgeInfo, is_captain: bool) -> PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerPlayersInner {
