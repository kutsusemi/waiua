...
impl PartiesV1PlayersPuuidGet200Response {
    pub fn new(subject: String, version: f64, current_party_id: String, invites: Option<serde_json::Value>, requests: Vec<models::PartiesV1PlayersPuuidGet200ResponseRequestsInner>, platform_info: models::PartiesV1PlayersPuuidGet200ResponsePlatformInfo) -> PartiesV1PlayersPuuidGet200Response {
