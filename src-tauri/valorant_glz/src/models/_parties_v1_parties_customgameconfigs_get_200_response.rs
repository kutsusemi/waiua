...
pub struct PartiesV1PartiesCustomgameconfigsGet200Response {
    ...
    pub game_pod_ping_service_info: std::collections::HashMap<String, models::PartiesV1PartiesCustomgameconfigsGet200ResponseGamePodPingServiceInfoValue>,
}

impl PartiesV1PartiesCustomgameconfigsGet200Response {
    pub fn new(enabled: bool, enabled_maps: Vec<String>, enabled_modes: Vec<String>, queues: Vec<models::PartiesV1PartiesCustomgameconfigsGet200ResponseQueuesInner>, game_pod_ping_service_info: std::collections::HashMap<String, models::PartiesV1PartiesCustomgameconfigsGet200ResponseGamePodPingServiceInfoValue>) -> PartiesV1PartiesCustomgameconfigsGet200Response {
        PartiesV1PartiesCustomgameconfigsGet200Response {
            enabled,
            enabled_maps,
            enabled_modes,
