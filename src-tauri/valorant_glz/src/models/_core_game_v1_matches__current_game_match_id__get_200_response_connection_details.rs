...
impl CoreGameV1MatchesCurrentGameMatchIdGet200ResponseConnectionDetails {
    pub fn new(game_server_hosts: Vec<String>, game_server_host: String, game_server_port: f64, game_server_obfuscated_ip: f64, game_client_hash: f64, player_key: String) -> CoreGameV1MatchesCurrentGameMatchIdGet200ResponseConnectionDetails {
