...
pub struct CoreGameV1MatchesCurrentGameMatchIdGet200Response {
    ...
    pub connection_details:
        Box<models::CoreGameV1MatchesCurrentGameMatchIdGet200ResponseConnectionDetails>,
...
impl CoreGameV1MatchesCurrentGameMatchIdGet200Response {
    pub fn new(
        ...
        map_id: String,
        mode_id: String,
        provisioning_flow: ProvisioningFlow,
        game_pod_id: String,
        all_muc_name: String,
        team_muc_name: String,
        team_voice_id: String,
        team_match_token: String,
        is_reconnectable: bool,
        connection_details: models::CoreGameV1MatchesCurrentGameMatchIdGet200ResponseConnectionDetails,
        post_game_details: Option<serde_json::Value>,
        players: Vec<models::CoreGameV1MatchesCurrentGameMatchIdGet200ResponsePlayersInner>,
        matchmaking_data: Option<serde_json::Value>,
