...
impl PregameV1MatchesPreGameMatchIdGet200Response {
    pub fn new(
        id: String,
        version: f64,
        teams: Vec<models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInner>,
        ally_team: Option<models::PregameV1MatchesPreGameMatchIdGet200ResponseAllyTeam>,
        enemy_team: Option<models::PregameV1MatchesPreGameMatchIdGet200ResponseAllyTeam>,
        ...
        map_select_step: f64,
        team1: models::PregameV1MatchesPreGameMatchIdGet200ResponseTeamsInnerTeamId,
        game_pod_id: String,
        mode: String,
        voice_session_id: String,
        muc_name: String,
        team_match_token: String,
        queue_id: models::PregameV1MatchesPreGameMatchIdGet200ResponseQueueId,
        ...
        PregameV1MatchesPreGameMatchIdGet200Response {
            ...
            version,
            teams,
            ally_team: if let Some(x) = ally_team {
                Some(Box::new(x))
            } else {
                None
            },
            enemy_team: if let Some(x) = enemy_team {
                Some(Box::new(x))
            } else {
                None
            },
