...
pub async fn account_xp_v1_players_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::AccountXpV1PlayersPuuidGet200Response, Error<AccountXpV1PlayersPuuidGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountXpV1PlayersPuuidGetError> =
...
pub async fn contract_definitions_v3_item_upgrades_get(
    configuration: &configuration::Configuration,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<
    models::ContractDefinitionsV3ItemUpgradesGet200Response,
    Error<ContractDefinitionsV3ItemUpgradesGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ContractDefinitionsV3ItemUpgradesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn contracts_v1_contracts_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::ContractsV1ContractsPuuidGet200Response, Error<ContractsV1ContractsPuuidGetError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ContractsV1ContractsPuuidGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn contracts_v1_contracts_puuid_special_contract_id_post(
    configuration: &configuration::Configuration,
    contract_id: &str,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    ...
    models::ContractsV1ContractsPuuidGet200Response,
    Error<ContractsV1ContractsPuuidSpecialContractIdPostError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/contracts/v1/contracts/{puuid}/special/{contract_id}",
        local_var_configuration.base_path,
        contract_id = crate::apis::urlencode(contract_id),
        puuid = crate::apis::urlencode(puuid)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ContractsV1ContractsPuuidSpecialContractIdPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn match_details_v1_matches_match_id_get(
    configuration: &configuration::Configuration,
    match_id: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    ...
    models::MatchDetailsV1MatchesMatchIdGet200Response,
    Error<MatchDetailsV1MatchesMatchIdGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MatchDetailsV1MatchesMatchIdGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn match_history_v1_history_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    ...
    models::MatchHistoryV1HistoryPuuidGet200Response,
    Error<MatchHistoryV1HistoryPuuidGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MatchHistoryV1HistoryPuuidGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn mmr_v1_leaderboards_affinity_na_queue_competitive_season_season_id_get(
    configuration: &configuration::Configuration,
    season_id: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    ...
    models::MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGet200Response,
    Error<MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGetError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/mmr/v1/leaderboards/affinity/na/queue/competitive/season/{season_id}",
        local_var_configuration.base_path,
        season_id = crate::apis::urlencode(season_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGetError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn mmr_v1_players_puuid_competitiveupdates_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    ...
    models::MmrV1PlayersPuuidCompetitiveupdatesGet200Response,
...
> {
    ...
    let local_var_uri_str = format!(
        "{}/mmr/v1/players/{puuid}/competitiveupdates",
        local_var_configuration.base_path,
        puuid = crate::apis::urlencode(puuid)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MmrV1PlayersPuuidCompetitiveupdatesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn mmr_v1_players_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::MmrV1PlayersPuuidGet200Response, Error<MmrV1PlayersPuuidGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MmrV1PlayersPuuidGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn name_service_v2_players_put(
    configuration: &configuration::Configuration,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<Vec<models::NameServiceV2PlayersPut200ResponseInner>, Error<NameServiceV2PlayersPutError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NameServiceV2PlayersPutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn personalization_v2_players_puuid_playerloadout_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    ...
    models::PersonalizationV2PlayersPuuidPlayerloadoutGet200Response,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PersonalizationV2PlayersPuuidPlayerloadoutGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn personalization_v2_players_puuid_playerloadout_put(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PersonalizationV2PlayersPuuidPlayerloadoutPutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restrictions_v3_penalties_get(
    configuration: &configuration::Configuration,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::RestrictionsV3PenaltiesGet200Response, Error<RestrictionsV3PenaltiesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestrictionsV3PenaltiesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn store_v1_entitlements_puuid_item_type_id_get(
    configuration: &configuration::Configuration,
    item_type_id: &str,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    ...
    models::StoreV1EntitlementsPuuidItemTypeIdGet200Response,
...
> {
    ...
    let local_var_uri_str = format!(
        "{}/store/v1/entitlements/{puuid}/{ItemTypeID}",
        local_var_configuration.base_path,
        ItemTypeID = crate::apis::urlencode(item_type_id),
        puuid = crate::apis::urlencode(puuid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoreV1EntitlementsPuuidItemTypeIdGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn store_v1_offers_get(
    configuration: &configuration::Configuration,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::StoreV1OffersGet200Response, Error<StoreV1OffersGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoreV1OffersGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn store_v1_wallet_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::StoreV1WalletPuuidGet200Response, Error<StoreV1WalletPuuidGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoreV1WalletPuuidGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn store_v2_storefront_puuid_get(
    configuration: &configuration::Configuration,
    puuid: &str,
    x_riot_entitlements_jwt: &str,
    x_riot_client_version: &str,
    x_riot_client_platform: &str,
) -> Result<models::StoreV2StorefrontPuuidGet200Response, Error<StoreV2StorefrontPuuidGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoreV2StorefrontPuuidGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn v1_config_region_get(
    configuration: &configuration::Configuration,
    region: &str,
) -> Result<models::V1ConfigRegionGet200Response, Error<V1ConfigRegionGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<V1ConfigRegionGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
