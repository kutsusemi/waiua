...
impl MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerStatsInner {
    pub fn new(
        subject: String,
        kills: Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerStatsInnerKillsInner>,
        damage: Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerStatsInnerDamageInner>,
        score: f64,
        economy: models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerStatsInnerEconomy,
