...
impl MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInner {
    pub fn new(
        ...
        game_name: String,
        tag_line: String,
        platform_info: models::MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerPlatformInfo,
        team_id: models::MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerTeamId,
        party_id: String,
        character_id: String,
        stats: Option<models::MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerStats>,
        round_damage: Option<
            Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerRoundDamageInner>,
        >,
