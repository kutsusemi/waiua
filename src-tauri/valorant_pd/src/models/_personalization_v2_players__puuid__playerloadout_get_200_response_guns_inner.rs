...
impl PersonalizationV2PlayersPuuidPlayerloadoutGet200ResponseGunsInner {
    ...
    pub fn new(id: String, skin_id: String, skin_level_id: String, chroma_id: String, attachments: Vec<serde_json::Value>) -> PersonalizationV2PlayersPuuidPlayerloadoutGet200ResponseGunsInner {
