...
pub struct MmrV1PlayersPuuidGet200Response {
    ...
    pub queue_skills: std::collections::HashMap<String, models::MmrV1PlayersPuuidGet200ResponseQueueSkillsValue>,
    #[serde(rename = "LatestCompetitiveUpdate")]
    pub latest_competitive_update: Box<models::MmrV1PlayersPuuidGet200ResponseLatestCompetitiveUpdate>,
...
impl MmrV1PlayersPuuidGet200Response {
    pub fn new(version: f64, subject: String, new_player_experience_finished: bool, queue_skills: std::collections::HashMap<String, models::MmrV1PlayersPuuidGet200ResponseQueueSkillsValue>, latest_competitive_update: models::MmrV1PlayersPuuidGet200ResponseLatestCompetitiveUpdate, is_leaderboard_anonymized: bool, is_act_rank_badge_hidden: bool) -> MmrV1PlayersPuuidGet200Response {
