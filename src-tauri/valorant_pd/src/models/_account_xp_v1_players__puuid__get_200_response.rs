...
impl AccountXpV1PlayersPuuidGet200Response {
    pub fn new(version: f64, subject: String, progress: models::AccountXpV1PlayersPuuidGet200ResponseProgress, history: Vec<models::AccountXpV1PlayersPuuidGet200ResponseHistoryInner>, last_time_granted_first_win: String, next_time_first_win_available: String) -> AccountXpV1PlayersPuuidGet200Response {
