...
pub struct ContractsV1ContractsPuuidGet200ResponseContractsInner {
    ...
    pub contract_progression: Box<models::ContractsV1ContractsPuuidGet200ResponseContractsInnerContractProgression>,
...
impl ContractsV1ContractsPuuidGet200ResponseContractsInner {
    pub fn new(contract_definition_id: String, contract_progression: models::ContractsV1ContractsPuuidGet200ResponseContractsInnerContractProgression, progression_level_reached: f64, progression_towards_next_level: f64) -> ContractsV1ContractsPuuidGet200ResponseContractsInner {
