...
impl ContractsV1ContractsPuuidGet200ResponseMissionsInner {
    pub fn new(id: String, objectives: std::collections::HashMap<String, f64>, complete: bool, expiration_time: String) -> ContractsV1ContractsPuuidGet200ResponseMissionsInner {
