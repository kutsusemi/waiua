...
pub struct StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundle {
    ...
    pub item_offers: Option<
        Vec<models::StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundleItemOffersInner>,
    >,
...
impl StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundle {
    pub fn new(
        ...
        currency_id: String,
        items: Vec<models::StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundleItemsInner>,
        item_offers: Option<
            Vec<models::StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundleItemOffersInner>,
        >,
