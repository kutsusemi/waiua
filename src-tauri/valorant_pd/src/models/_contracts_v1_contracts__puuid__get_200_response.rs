...
pub struct ContractsV1ContractsPuuidGet200Response {
    ...
    pub processed_matches:
        Vec<models::ContractsV1ContractsPuuidGet200ResponseProcessedMatchesInner>,
    /// UUID
...
impl ContractsV1ContractsPuuidGet200Response {
    pub fn new(
        version: f64,
        subject: String,
        contracts: Vec<models::ContractsV1ContractsPuuidGet200ResponseContractsInner>,
        processed_matches: Vec<
            models::ContractsV1ContractsPuuidGet200ResponseProcessedMatchesInner,
        >,
        active_special_contract: String,
        missions: Vec<models::ContractsV1ContractsPuuidGet200ResponseMissionsInner>,
        mission_metadata: models::ContractsV1ContractsPuuidGet200ResponseMissionMetadata,
