...
impl MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGet200Response {
    pub fn new(deployment: String, queue_id: String, season_id: String, players: Vec<models::MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGet200ResponsePlayersInner>, total_players: f64, immortal_starting_page: f64, immortal_starting_index: f64, top_tier_rr_threshold: f64, tier_details: std::collections::HashMap<String, models::MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGet200ResponseTierDetailsValue>, start_index: f64, query: String) -> MmrV1LeaderboardsAffinityNaQueueCompetitiveSeasonSeasonIdGet200Response {
