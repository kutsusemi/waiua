...
impl StoreV1OffersGet200ResponseOffersInner {
    pub fn new(offer_id: String, is_direct_purchase: bool, start_date: String, cost: std::collections::HashMap<String, f64>, rewards: Vec<models::StoreV1OffersGet200ResponseOffersInnerRewardsInner>) -> StoreV1OffersGet200ResponseOffersInner {
