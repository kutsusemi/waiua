...
impl MmrV1PlayersPuuidGet200ResponseQueueSkillsValueSeasonalInfoBySeasonIdValue {
    pub fn new(season_id: String, number_of_wins: f64, number_of_wins_with_placements: f64, number_of_games: f64, rank: f64, capstone_wins: f64, leaderboard_rank: f64, competitive_tier: f64, ranked_rating: f64, wins_by_tier: Option<std::collections::HashMap<String, f64>>, games_needed_for_rating: f64, total_wins_needed_for_rank: f64) -> MmrV1PlayersPuuidGet200ResponseQueueSkillsValueSeasonalInfoBySeasonIdValue {
        MmrV1PlayersPuuidGet200ResponseQueueSkillsValueSeasonalInfoBySeasonIdValue {
            season_id,
            number_of_wins,
