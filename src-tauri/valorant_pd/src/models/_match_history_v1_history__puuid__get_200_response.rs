...
impl MatchHistoryV1HistoryPuuidGet200Response {
    pub fn new(subject: String, begin_index: f64, end_index: f64, total: f64, history: Vec<models::MatchHistoryV1HistoryPuuidGet200ResponseHistoryInner>) -> MatchHistoryV1HistoryPuuidGet200Response {
