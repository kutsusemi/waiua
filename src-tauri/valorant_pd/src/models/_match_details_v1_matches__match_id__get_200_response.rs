...
pub struct MatchDetailsV1MatchesMatchIdGet200Response {
    ...
    pub round_results: Option<Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInner>>,
