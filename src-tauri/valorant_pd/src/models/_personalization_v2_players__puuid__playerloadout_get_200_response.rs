...
impl PersonalizationV2PlayersPuuidPlayerloadoutGet200Response {
    pub fn new(
        subject: String,
        version: f64,
        guns: Vec<models::PersonalizationV2PlayersPuuidPlayerloadoutGet200ResponseGunsInner>,
        sprays: Vec<models::PersonalizationV2PlayersPuuidPlayerloadoutGet200ResponseSpraysInner>,
