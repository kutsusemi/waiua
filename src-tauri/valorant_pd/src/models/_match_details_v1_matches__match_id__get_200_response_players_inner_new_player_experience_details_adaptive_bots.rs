...
impl MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerNewPlayerExperienceDetailsAdaptiveBots {
    pub fn new(
        adaptive_bot_average_duration_millis_all_attempts: AdaptiveBotAverageDurationMillisAllAttempts,
        adaptive_bot_average_duration_millis_first_attempt: AdaptiveBotAverageDurationMillisFirstAttempt,
        kill_details_first_attempt: Option<serde_json::Value>,
