...
impl StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundleItemOffersInner {
    pub fn new(bundle_item_offer_id: String, offer: models::StoreV1OffersGet200ResponseOffersInner, discount_percent: f64, discounted_cost: std::collections::HashMap<String, f64>) -> StoreV2StorefrontPuuidGet200ResponseFeaturedBundleBundleItemOffersInner {
