...
impl MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInner {
    pub fn new(
        ...
        winning_team: models::MatchDetailsV1MatchesMatchIdGet200ResponsePlayersInnerTeamId,
        plant_player_locations: Option<Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlantPlayerLocationsInner>>,
        plant_location: models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlantPlayerLocationsInnerLocation,
        plant_site: PlantSite,
        defuse_player_locations: Option<Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlantPlayerLocationsInner>>,
        defuse_location: models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlantPlayerLocationsInnerLocation,
        player_stats: Vec<
            models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerStatsInner,
        >,
        round_result_code: RoundResultCode,
        player_economies: Option<Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerEconomiesInner>>,
        player_scores: Option<Vec<models::MatchDetailsV1MatchesMatchIdGet200ResponseRoundResultsInnerPlayerScoresInner>>,
