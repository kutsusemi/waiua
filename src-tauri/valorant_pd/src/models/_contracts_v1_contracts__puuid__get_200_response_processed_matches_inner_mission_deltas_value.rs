...
impl ContractsV1ContractsPuuidGet200ResponseProcessedMatchesInnerMissionDeltasValue {
    pub fn new(
        ...
        objective_deltas: std::collections::HashMap<String, models::ContractsV1ContractsPuuidGet200ResponseProcessedMatchesInnerMissionDeltasValueObjectiveDeltasValue>,
