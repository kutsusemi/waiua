...
impl AccountXpV1PlayersPuuidGet200ResponseHistoryInner {
    pub fn new(id: String, match_start: String, start_progress: models::AccountXpV1PlayersPuuidGet200ResponseProgress, end_progress: models::AccountXpV1PlayersPuuidGet200ResponseProgress, xp_delta: f64, xp_sources: Vec<models::AccountXpV1PlayersPuuidGet200ResponseHistoryInnerXpSourcesInner>, xp_multipliers: Vec<serde_json::Value>) -> AccountXpV1PlayersPuuidGet200ResponseHistoryInner {
