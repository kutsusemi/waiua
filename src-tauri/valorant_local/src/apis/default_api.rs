...
pub async fn chat_v1_session_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV1SessionGet200Response, Error<ChatV1SessionGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV1SessionGetError> =
...
pub async fn chat_v4_friendrequests_delete(
    configuration: &configuration::Configuration,
) -> Result<serde_json::Value, Error<ChatV4FriendrequestsDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV4FriendrequestsDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v4_friendrequests_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV4FriendrequestsGet200Response, Error<ChatV4FriendrequestsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV4FriendrequestsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v4_friendrequests_post(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV4FriendrequestsPost200Response, Error<ChatV4FriendrequestsPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV4FriendrequestsPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v4_friends_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV4FriendsGet200Response, Error<ChatV4FriendsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV4FriendsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v4_presences_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV4PresencesGet200Response, Error<ChatV4PresencesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV4PresencesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v5_participants_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV5ParticipantsGet200Response, Error<ChatV5ParticipantsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV5ParticipantsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_conversations_ares_coregame_get(
    configuration: &configuration::Configuration,
) -> Result<
    models::ChatV6ConversationsAresPartiesGet200Response,
    Error<ChatV6ConversationsAresCoregameGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6ConversationsAresCoregameGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_conversations_ares_parties_get(
    configuration: &configuration::Configuration,
) -> Result<
    models::ChatV6ConversationsAresPartiesGet200Response,
    Error<ChatV6ConversationsAresPartiesGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6ConversationsAresPartiesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_conversations_ares_pregame_get(
    configuration: &configuration::Configuration,
) -> Result<
    models::ChatV6ConversationsAresPartiesGet200Response,
    Error<ChatV6ConversationsAresPregameGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6ConversationsAresPregameGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_conversations_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV6ConversationsAresPartiesGet200Response, Error<ChatV6ConversationsGetError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6ConversationsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_messages_get(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV6MessagesGet200Response, Error<ChatV6MessagesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6MessagesGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn chat_v6_messages_post(
    configuration: &configuration::Configuration,
) -> Result<models::ChatV6MessagesGet200Response, Error<ChatV6MessagesPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChatV6MessagesPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn entitlements_v1_token_get(
    configuration: &configuration::Configuration,
) -> Result<models::EntitlementsV1TokenGet200Response, Error<EntitlementsV1TokenGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EntitlementsV1TokenGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn help_get(
    configuration: &configuration::Configuration,
) -> Result<models::HelpGet200Response, Error<HelpGetError>> {
    let local_var_configuration = configuration;
...
pub async fn player_account_aliases_v1_active_get(
    configuration: &configuration::Configuration,
) -> Result<
    models::PlayerAccountAliasesV1ActiveGet200Response,
    Error<PlayerAccountAliasesV1ActiveGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PlayerAccountAliasesV1ActiveGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn product_session_v1_external_sessions_get(
    configuration: &configuration::Configuration,
) -> Result<
    std::collections::HashMap<String, models::ProductSessionV1ExternalSessionsGet200ResponseValue>,
    Error<ProductSessionV1ExternalSessionsGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProductSessionV1ExternalSessionsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn riotclient_region_locale_get(
    configuration: &configuration::Configuration,
) -> Result<models::RiotclientRegionLocaleGet200Response, Error<RiotclientRegionLocaleGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RiotclientRegionLocaleGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Get RSO user info
pub async fn rso_auth_v1_authorization_userinfo_get(
    configuration: &configuration::Configuration,
) -> Result<
    models::RsoAuthV1AuthorizationUserinfoGet200Response,
    Error<RsoAuthV1AuthorizationUserinfoGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RsoAuthV1AuthorizationUserinfoGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn swagger_v3_openapi_json_get(
    configuration: &configuration::Configuration,
) -> Result<serde_json::Value, Error<SwaggerV3OpenapiJsonGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SwaggerV3OpenapiJsonGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
