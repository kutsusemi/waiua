...
pub struct ChatV4PresencesGet200ResponsePresencesInner {
    ...
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "patchline", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "privateJwt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ChatV4PresencesGet200ResponsePresencesInner {
    pub fn new(basic: String, game_name: String, game_tag: String, name: String, pid: String, private: Option<String>, product: Product, puuid: String, region: String, resource: String, state: State, summary: String, time: f64) -> ChatV4PresencesGet200ResponsePresencesInner {
