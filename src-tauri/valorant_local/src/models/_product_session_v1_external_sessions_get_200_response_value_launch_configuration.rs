...
impl ProductSessionV1ExternalSessionsGet200ResponseValueLaunchConfiguration {
    pub fn new(arguments: Vec<String>, executable: String, locale: Option<String>, voice_locale: Option<serde_json::Value>, working_directory: String) -> ProductSessionV1ExternalSessionsGet200ResponseValueLaunchConfiguration {
