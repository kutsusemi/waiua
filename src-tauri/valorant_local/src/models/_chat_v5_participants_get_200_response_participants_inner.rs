...
impl ChatV5ParticipantsGet200ResponseParticipantsInner {
    pub fn new(active_platform: Option<serde_json::Value>, cid: String, game_name: String, game_tag: String, muted: bool, name: String, pid: String, puuid: String, region: String) -> ChatV5ParticipantsGet200ResponseParticipantsInner {
