...
impl ChatV4FriendrequestsGet200ResponseRequestsInner {
    pub fn new(game_name: String, game_tag: String, name: String, note: String, pid: String, puuid: String, region: String, subscription: Subscription) -> ChatV4FriendrequestsGet200ResponseRequestsInner {
