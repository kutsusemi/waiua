...
pub struct ChatV6ConversationsAresPartiesGet200ResponseConversationsInner {
    ...
    pub ui_state: Box<models::ChatV6ConversationsAresPartiesGet200ResponseConversationsInnerUiState>,
    #[serde(rename = "unread_count")]
    pub unread_count: f64,
}

impl ChatV6ConversationsAresPartiesGet200ResponseConversationsInner {
    pub fn new(cid: String, direct_messages: bool, global_readership: bool, message_history: bool, mid: String, muted: bool, muted_restriction: bool, r#type: Type, ui_state: models::ChatV6ConversationsAresPartiesGet200ResponseConversationsInnerUiState, unread_count: f64) -> ChatV6ConversationsAresPartiesGet200ResponseConversationsInner {
