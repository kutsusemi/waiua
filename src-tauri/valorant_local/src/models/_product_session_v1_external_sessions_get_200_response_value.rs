...
pub struct ProductSessionV1ExternalSessionsGet200ResponseValue {
    ...
    pub launch_configuration:
        Box<models::ProductSessionV1ExternalSessionsGet200ResponseValueLaunchConfiguration>,
...
impl ProductSessionV1ExternalSessionsGet200ResponseValue {
    pub fn new(
        exit_code: f64,
        exit_reason: Option<serde_json::Value>,
        is_internal: bool,
        launch_configuration: models::ProductSessionV1ExternalSessionsGet200ResponseValueLaunchConfiguration,
        patchline_full_name: PatchlineFullName,
        patchline_id: PatchlineId,
        phase: String,
