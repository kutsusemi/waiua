...
impl ContentServiceV3ContentGet200Response {
    pub fn new(
        disabled_ids: Vec<serde_json::Value>,
        seasons: Vec<models::ContentServiceV3ContentGet200ResponseSeasonsInner>,
        events: Vec<models::ContentServiceV3ContentGet200ResponseEventsInner>,
