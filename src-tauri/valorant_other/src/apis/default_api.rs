...
pub async fn auth_riotgames_com_api_v1_authorization_post(configuration: &configuration::Configuration, ) -> Result<models::AuthRiotgamesComApiV1AuthorizationPut200Response, Error<AuthRiotgamesComApiV1AuthorizationPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}//auth.riotgames.com/api/v1/authorization", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthRiotgamesComApiV1AuthorizationPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn auth_riotgames_com_api_v1_authorization_put(configuration: &configuration::Configuration, ) -> Result<models::AuthRiotgamesComApiV1AuthorizationPut200Response, Error<AuthRiotgamesComApiV1AuthorizationPutError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthRiotgamesComApiV1AuthorizationPutError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn auth_riotgames_com_userinfo_get(configuration: &configuration::Configuration, token: &str) -> Result<models::AuthRiotgamesComUserinfoGet200Response, Error<AuthRiotgamesComUserinfoGetError>> {
    ...
    let local_var_uri_str = format!("{}//auth.riotgames.com/userinfo", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AuthRiotgamesComUserinfoGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn clientconfig_rpg_riotgames_com_api_v1_config_playerapp_riot20_client_get(configuration: &configuration::Configuration, token: &str, entitlement: &str) -> Result<models::ClientconfigRpgRiotgamesComApiV1ConfigPlayerAppRiot20ClientGet200Response, Error<ClientconfigRpgRiotgamesComApiV1ConfigPlayerappRiot20ClientGetError>> {
    ...
    let local_var_uri_str = format!("{}//clientconfig.rpg.riotgames.com/api/v1/config/player?app=Riot%20Client", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ClientconfigRpgRiotgamesComApiV1ConfigPlayerappRiot20ClientGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn entitlements_auth_riotgames_com_api_token_v1_post(configuration: &configuration::Configuration, token: &str) -> Result<models::EntitlementsAuthRiotgamesComApiTokenV1Post200Response, Error<EntitlementsAuthRiotgamesComApiTokenV1PostError>> {
    ...
    let local_var_uri_str = format!("{}//entitlements.auth.riotgames.com/api/token/v1", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EntitlementsAuthRiotgamesComApiTokenV1PostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn riot_geo_pas_si_riotgames_com_pas_v1_product_valorant_put(configuration: &configuration::Configuration, token: &str) -> Result<models::RiotGeoPasSiRiotgamesComPasV1ProductValorantPut200Response, Error<RiotGeoPasSiRiotgamesComPasV1ProductValorantPutError>> {
    ...
    let local_var_uri_str = format!("{}//riot_geo.pas.si.riotgames.com/pas/v1/product/valorant", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RiotGeoPasSiRiotgamesComPasV1ProductValorantPutError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn riot_geo_pas_si_riotgames_com_pas_v1_service_chat_get(configuration: &configuration::Configuration, token: &str) -> Result<String, Error<RiotGeoPasSiRiotgamesComPasV1ServiceChatGetError>> {
    ...
    let local_var_uri_str = format!("{}//riot_geo.pas.si.riotgames.com/pas/v1/service/chat", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RiotGeoPasSiRiotgamesComPasV1ServiceChatGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
